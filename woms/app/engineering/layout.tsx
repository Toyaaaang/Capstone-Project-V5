...
import { Menu } from "@/components/sidebar-contents/engineering";
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
...
export default function EngineeringLayout({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    if (pathname === "/engineering/dashboard") {
  ...
  return (
    <RoleLayout allowedRoles={["engineering"]}>
      <SidebarProvider>
                  ...
                  <Breadcrumb className="select-none">
                    <BreadcrumbList>
                      <BreadcrumbItem className="hidden md:block">
                        <BreadcrumbLink href="/engineering/dashboard">
