...
export default function SubOfficeOverview() {
  ...
  useEffect(() => {
    ...
    if (!session?.user || session.user.role !== "sub_office") {
  ...
  return (
    <div className="p-4">
      <h1 className="text-2xl font-bold mb-4">Sub-Office Overview</h1>
      <div className="flex flex-1 flex-col">
        <div className="@container/main flex flex-1 flex-col gap-2">
          <div className="flex flex-col gap-4 py-4 md:gap-6 md:py-6">
            <SectionCards role="sub_office" />
